class AboutsController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @about.update(about_params)
        format.html { redirect_to @about, notice: "About was successfully updated.", status: :see_other }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to abouts_path, notice: "About was successfully destroyed.", status: :see_other }
