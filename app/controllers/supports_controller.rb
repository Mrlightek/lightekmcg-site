class SupportsController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @support.update(support_params)
        format.html { redirect_to @support, notice: "Support was successfully updated.", status: :see_other }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to supports_path, notice: "Support was successfully destroyed.", status: :see_other }
  ...
  private
    ...
    def set_support
      @support = Support.find(params.expect(:id))
    end
